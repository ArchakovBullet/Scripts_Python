''''''' Вторая программа "Шарик за курсором, стр. 47 книги." '''
...
print('\nПробел - смена фона на синий')
print('\nЦифра 1 = Серый цвет\n')
print('Цифра 2 = Зеленый цвет \n')
print('Цифра 3 = Белый цвет\n')
print('+ = Увеличить размер шарика.')
print('- = Уменьшить размер шарика.')
print('\n' + "#" * 50)
print("#" * 50)
